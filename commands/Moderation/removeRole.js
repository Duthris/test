...
module.exports = {
  name: "rol2", 
  category: "Moderation", 
  aliases: ["removerole", "rolkaldır"], 
  cooldown: 0, 
  usage: "rol2 @kişi @rol", 
  description: "Etiketlenen kişiden, etiketlenen rolü siler.", 
  memberpermissions: [], 
  requiredroles: [], 
  alloweduserids: [], 
  minargs: 0, 
    ...
    try {
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setTitle("<a:check:927241846726484009> | Rol başarıyla kaldırıldı.")
          .setDescription(`${targetMember} kişisinden ${targetRole} rolü alındı.`)
        ]
      }).then(msg => {
        setTimeout(() => {
          message.delete()
